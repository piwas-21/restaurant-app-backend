...
public sealed class RepairLegacyTableServiceSessionCommandValidator
    : AbstractValidator<RepairLegacyTableServiceSessionCommand>
{
    public RepairLegacyTableServiceSessionCommandValidator()
    {
