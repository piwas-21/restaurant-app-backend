...
/// service hands a new subscriber the recent buffer on connect. That is the same PII leak the
/// id-addressed order routes had, except a customer needed no order id at all, only a
/// connection. Its sibling streams were already gated (kitchen, all); this one was the outlier.
/// </summary>
