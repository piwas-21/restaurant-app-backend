...
namespace RestaurantSystem.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260922115402_AddTableServicePaymentHandoffs")] // pragma: allowlist secret
    partial class AddTableServicePaymentHandoffs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("LastEmailVerificationSentAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_email_verification_sent_at");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.Category", b =>
                {
                    ...
                    b.Property<int?>("AvailableOrderTypes")
                        .HasColumnType("integer")
                        .HasColumnName("available_order_types");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.GlobalIngredient", b =>
                {
                    ...
                    b.Property<bool>("IsNoneOption")
                        .HasColumnType("boolean")
                        .HasColumnName("is_none_option");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<string>("GuestStatusToken")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("guest_status_token");
                    ...
                    b.Property<long>("LastChangeSequence")
                        ...
                        .HasDefaultValue(0L)
                        .HasColumnName("last_change_sequence");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.OrderChange", b =>
                {
                    ...
                    b.HasIndex("OrderId")
                        .HasDatabaseName("ix_order_changes_order_id");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.OrderItemIngredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_order_item_ingredients");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.OrderRoutingState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTime?>("LastAcknowledgedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_acknowledged_at");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_order_routing_states");

                    b.HasIndex("OrderId", "CreatedAt");

                    b.HasIndex("JobId", "Revision", "Target")
                        .IsUnique();

                    b.ToTable("OrderRoutingStates", (string)null);
                });
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.OrderTypeConfiguration", b =>
                {
                    ...
                    b.Property<string>("ConfirmationFlow")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("confirmation_flow");
                    ...
                    b.Property<int>("ReviewWindowMinutes")
                        .HasColumnType("integer")
                        .HasColumnName("review_window_minutes");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.OutboundEmail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("EmailType", "EntityId")
                        .IsUnique();

                    b.ToTable("outbound_emails");
                });
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.PrinterDevice", b =>
                {
                    ...
                    b.Property<string>("KitchenRoutingMode")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasDefaultValue("Stations")
                        .HasColumnName("kitchen_routing_mode");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.PrinterDeviceTargetCapability", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("AutoPrintEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("auto_print_enabled");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_printer_device_target_capabilities");

                    b.HasIndex("DeviceId", "Target")
                        .IsUnique();

                    b.HasIndex("Target", "ReportedAt");

                    b.ToTable("PrinterDeviceTargetCapabilities", (string)null);
                });
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<bool>("HideBaseProduct")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("hide_base_product");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.ProductIngredient", b =>
                {
                    ...
                    b.Property<string>("ExclusionGroup")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("exclusion_group");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.RestaurantInfo", b =>
                {
                    ...
                    b.Property<bool>("ShowMenuBundlesOnAllTab")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("show_menu_bundles_on_all_tab");

                    b.Property<string>("ThemePaletteKey")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("theme_palette_key");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.SetupChecklistState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.PrimitiveCollection<List<string>>("AcknowledgedSteps")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                        .HasColumnName("acknowledged_steps")
                        .HasDefaultValueSql("'{}'");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_setup_checklist_state");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.TableServicePaymentHandoff", b =>
                {
                    ...
                    b.Property<int?>("CancellationExpectedVersion")
                        .HasColumnType("integer")
                        .HasColumnName("cancellation_expected_version");
                    ...
                    b.Property<Guid?>("ResolvedPaymentOperationId")
                        .HasColumnType("uuid")
                        .HasColumnName("resolved_payment_operation_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_table_service_payment_handoffs");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.WorkingHoursShift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_working_hours_shifts");

                    b.HasIndex("WorkingHoursId", "OpenTime");

                    b.ToTable("working_hours_shifts");
                });
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.OrderChange", b =>
                {
                    b.HasOne("RestaurantSystem.Domain.Entities.Order", "Order")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_order_changes_orders_order_id");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.OrderItemIngredient", b =>
                {
                    b.HasOne("RestaurantSystem.Domain.Entities.OrderItem", "OrderItem")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_item_ingredients_order_items_order_item_id");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.OrderRoutingState", b =>
                {
                    b.HasOne("RestaurantSystem.Domain.Entities.Order", "Order")
                        .WithMany("RoutingStates")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_routing_states_orders_order_id");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.TableServicePaymentHandoff", b =>
                {
                    b.HasOne("RestaurantSystem.Domain.Entities.TableServiceSession", "ServiceSession")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_table_service_payment_handoffs_tableservicesessions_service~");
            ...
            modelBuilder.Entity("RestaurantSystem.Domain.Entities.WorkingHoursShift", b =>
                {
                    b.HasOne("RestaurantSystem.Domain.Entities.WorkingHours", "WorkingHours")
                        .WithMany("Shifts")
